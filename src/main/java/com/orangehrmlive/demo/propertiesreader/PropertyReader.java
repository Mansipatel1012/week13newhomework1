package com.orangehrmlive.demo.propertiesreader;
...
//src/test/java/resources/propertiesfile/config.properities  // right click on config then copy path reference then coy root